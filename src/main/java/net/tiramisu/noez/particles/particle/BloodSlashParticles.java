...
public class BloodSlashParticles extends TextureSheetParticle {

    private SpriteSet spriteSet;

    protected BloodSlashParticles(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double pXSpeed, double pYSpeed, double pZSpeed) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            return new BloodSlashParticles(level, x, y, z, this.spriteSet, dx, dy, dz);
        }
    }
}