...
public class SylvanRootParticles extends TextureSheetParticle {

    private SpriteSet spriteSet;

    protected SylvanRootParticles(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, double pXSpeed, double pYSpeed, double pZSpeed) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            return new SylvanRootParticles(level, x, y, z, this.spriteSet, dx, dy, dz);
        }
    }
}